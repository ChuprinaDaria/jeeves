...
def trigger_document_processing(sender, instance, created, **kwargs):
    if created and not instance.is_processed:
        from Jeeves.processing.tasks import process_client_document as _task
    ...
    if not created and instance.pk:  # Only for existing instances
        try:
            ...
            if (old_status != instance.status and 
                ...
                from Jeeves.clients.tasks import process_web_parsing_request
...
class ClientQRCode(models.Model):
    ...
    def get_whatsapp_prefill(self) -> str:
        ...
        from Jeeves.clients.qr_utils import build_start2_prefill
    ...
    def get_whatsapp_link(self) -> str:
        ...
        from Jeeves.clients.qr_utils import build_wa_me_link
    ...
    def generate_qr_code(self):
        ...
        try:
            ...
            from Jeeves.clients.qr_utils import render_qr_with_logo, save_qr_png_to_field
