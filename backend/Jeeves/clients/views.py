...
from Jeeves.clients.models import (
    Client,
    ClientDocument,
    ClientAPIKey,
    ClientAPIConfig,
...
from Jeeves.clients.serializers import (
    ClientSerializer,
...
from Jeeves.clients.permissions import IsAdminOrReadOnly, IsClientOwner
...
class SendDailyDigestNowView(APIView):
    ...
    def post(self, request):
        ...
        from Jeeves.clients.tasks import send_daily_digest
...
class ClientExtensionPageView(APIView):
    ...
    def post(self, request):
        ...
        if mode in ('scrap', 'both') and full_text:
            try:
                from Jeeves.clients.models import ClientDocument
                ...
                try:
                    from Jeeves.EmbeddingModel.models import EmbeddingModel  # Local import to avoid circular deps
...
class ClientWebKnowledgeView(APIView):
    ...
    def post(self, request):
        from Jeeves.clients.models import WebParsingRequest
...
class ClientRecentActivityView(APIView):
    ...
    def get(self, request):
        ...
        from Jeeves.clients.models import Lead
...
class ClientModelStatusView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            try:
                from Jeeves.clients.models import KnowledgeBlock
