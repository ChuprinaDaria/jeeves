...
def start_zero_container_task(self, config_id: int) -> Dict[str, Any]:
    ...
    """
    from Jeeves.clients.models import ClientZeroConfig
    from Jeeves.clients.docker_manager import ZeroDockerManager
...
def process_web_parsing_request(self, parsing_request_id: int) -> Dict[str, Any]:
    ...
    """
    from Jeeves.clients.models import WebParsingRequest, KnowledgeBlock, ClientDocument
    import requests
    import os
...
def send_rating_request(self, conversation_id: int):
    ...
    try:
        ...
        if platform == 'web' or platform == 'web_widget' or platform == 'iframe':
                ...
                try:
                    ...
                    try:
                        ...
                        if response_data.get('ok') is True:
                            ...
                            try:
                                from Jeeves.clients.tasks import send_chat_summary_email, format_chat_as_text, generate_chat_summary
            ...
            from Jeeves.clients.views_meta_whatsapp import send_whatsapp_text
...
def process_manager_hitl_response(conversation_id: int, manager_response: str, manager_telegram_id: int) -> Dict[str, Any]:
    ...
    from Jeeves.rag.llm_client import LLMClient
    from django.utils import timezone
    from Jeeves.clients.views_telegram import send_telegram_message
