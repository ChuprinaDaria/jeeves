...
class ClientAdmin(admin.ModelAdmin):
    ...
    def start_zero_service(self, request, queryset):
        ...
        from Jeeves.clients.tasks import start_zero_container_task
    ...
    def stop_zero_service(self, request, queryset):
        ...
        from Jeeves.clients.tasks import stop_zero_container_task
    ...
    def restart_zero_service(self, request, queryset):
        ...
        from Jeeves.clients.tasks import restart_zero_container_task
    ...
    def check_zero_health(self, request, queryset):
        ...
        from Jeeves.clients.tasks import check_zero_container_health_task
...
class NewsAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not obj.image and not obj.image_url:
            from Jeeves.clients.news_utils import get_unsplash_image_url
            keyword = 'technology'
        ...
        if not obj.translations or (change and ('title' in form.changed_data or 'description' in form.changed_data)):
            from Jeeves.clients.news_utils import generate_translations
            try:
