...
class MetaWhatsAppWebhookView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Якщо секрет налаштовано — підпис ОБОВ'ЯЗКОВИЙ. Інакше атакуючий
            # обходить перевірку, просто не надіславши X-Hub-Signature-256.
            if meta_app_secret:
    ...
    def handle_message(self, message, metadata):
        ...
        try:
            ...
            from Jeeves.clients.models import Client, ClientWhatsAppConversation, ClientQRCode
            client = None
