...
DEFAULT_ASSISTANT_PROMPT = (
    ...
    "You can make things run automatically with canvas_create_trigger:\n"
    "- 'webhook': an external system POSTs to a secret URL → you run with that "
    "payload. Returns the URL to give them.\n"
    "- 'schedule': you run every N seconds (min 60).\n"
    "Ask the owner WHEN it fires, WHAT to do, and WHICH agent first. Use "
    "canvas_list_triggers / canvas_remove_trigger to manage them.\n\n"
    "## Skills\n"
