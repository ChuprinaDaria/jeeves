...
from Jeeves.rag.vector_search import SearchResult
from Jeeves.branches.models import BranchEmbedding, BranchDocument
from Jeeves.specializations.models import SpecializationEmbedding, SpecializationDocument
