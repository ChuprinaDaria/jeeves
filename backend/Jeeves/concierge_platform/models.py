...
class FeatureFlag(models.Model):
    ...
    # agent architecture and SSE streaming are the platform default — a DB
    # row with rollout='off'/'selected' remains available as an explicit
    # opt-out.
    DEFAULT_ON = frozenset({'mcp_real_agent', 'mcp_sse_streaming'})
