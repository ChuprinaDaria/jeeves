...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "corsheaders",
    "Jeeves.EmbeddingModel",
    "Jeeves.accounts",
    "Jeeves.branches",
    "Jeeves.specializations",
    "Jeeves.clients",
    "Jeeves.api",
    "Jeeves.processing",
    "Jeeves.rag",
    "Jeeves.concierge_platform",
    "Jeeves.tools",
    "Jeeves.agents",
    "Jeeves.mcp_hub",
]
...
MIDDLEWARE = [
    "Jeeves.fix_domain_middleware.FixDomainMiddleware",
    ...
    "Jeeves.iframe_middleware.AllowIframeMiddleware",
    "Jeeves.clients.middleware.ClientAPIKeyMiddleware",
    "Jeeves.rate_limit_middleware.RateLimitMiddleware",
]
...
CELERY_TASK_ANNOTATIONS = {
    "Jeeves.processing.tasks.process_client_document": {"rate_limit": "10/m"},
    "Jeeves.processing.tasks.process_branch_document": {"rate_limit": "10/m"},
    "Jeeves.processing.tasks.process_specialization_document": {"rate_limit": "10/m"},
}
...
CELERY_BEAT_SCHEDULE = {
    'check-inactive-chat-sessions': {
        'task': 'Jeeves.clients.tasks.check_inactive_chat_sessions',
        'schedule': 60.0,  # Run every 60 seconds (1 minute)
    },
    'send-daily-digest': {
        'task': 'Jeeves.clients.tasks.send_daily_digest',
...
# If not set, default mapping is used (see Jeeves.clients.package_sync)
# MG_PACKAGE_TYPE_MAP = {}
