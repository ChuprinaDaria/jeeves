...
const SERVER_COLORS = {
  ...
  'meta-facebook':   { border: 'border-[#1877F2]', bg: 'bg-[#1877F2]/10', text: 'text-[#1877F2]' },
  'meta-instagram':  { border: 'border-[#E4405F]', bg: 'bg-[#E4405F]/10', text: 'text-[#E4405F]' },
  'linkedin':        { border: 'border-[#0A66C2]', bg: 'bg-[#0A66C2]/10', text: 'text-[#0A66C2]' },
